...
pub const NGHTTP2_VERSION: &[u8; 7] = b"1.68.0\0";
pub const NGHTTP2_VERSION_NUM: u32 = 82944;
pub const NGHTTP2_PROTO_VERSION_ID: &[u8; 3] = b"h2\0";
pub const NGHTTP2_PROTO_VERSION_ID_LEN: u32 = 2;
pub const NGHTTP2_PROTO_ALPN: &[u8; 4] = b"\x02h2\0";
pub const NGHTTP2_CLEARTEXT_PROTO_VERSION_ID: &[u8; 4] = b"h2c\0";
pub const NGHTTP2_CLEARTEXT_PROTO_VERSION_ID_LEN: u32 = 3;
pub const NGHTTP2_VERSION_AGE: u32 = 1;
pub const NGHTTP2_DEFAULT_WEIGHT: u32 = 16;
pub const NGHTTP2_MAX_WEIGHT: u32 = 256;
pub const NGHTTP2_MIN_WEIGHT: u32 = 1;
pub const NGHTTP2_INITIAL_WINDOW_SIZE: u32 = 65535;
pub const NGHTTP2_INITIAL_CONNECTION_WINDOW_SIZE: u32 = 65535;
pub const NGHTTP2_DEFAULT_HEADER_TABLE_SIZE: u32 = 4096;
pub const NGHTTP2_CLIENT_MAGIC: &[u8; 25] = b"PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n\0";
pub const NGHTTP2_CLIENT_MAGIC_LEN: u32 = 24;
pub const NGHTTP2_DEFAULT_MAX_SETTINGS: u32 = 32;
pub const NGHTTP2_INITIAL_MAX_CONCURRENT_STREAMS: u32 = 2147483647;
pub const NGHTTP2_EXTPRI_DEFAULT_URGENCY: u32 = 3;
pub const NGHTTP2_EXTPRI_URGENCY_HIGH: u32 = 0;
pub const NGHTTP2_EXTPRI_URGENCY_LOW: u32 = 7;
pub const NGHTTP2_EXTPRI_URGENCY_LEVELS: u32 = 8;
...
const _: () = {
    ["Size of nghttp2_info"][::std::mem::size_of::<nghttp2_info>() - 24usize];
    ["Alignment of nghttp2_info"][::std::mem::align_of::<nghttp2_info>() - 8usize];
    ["Offset of field: nghttp2_info::age"][::std::mem::offset_of!(nghttp2_info, age) - 0usize];
    ["Offset of field: nghttp2_info::version_num"]
        [::std::mem::offset_of!(nghttp2_info, version_num) - 4usize];
    ["Offset of field: nghttp2_info::version_str"]
        [::std::mem::offset_of!(nghttp2_info, version_str) - 8usize];
    ["Offset of field: nghttp2_info::proto_str"]
        [::std::mem::offset_of!(nghttp2_info, proto_str) - 16usize];
};
#[doc = " Invalid argument passed."]
pub const nghttp2_error_NGHTTP2_ERR_INVALID_ARGUMENT: nghttp2_error = -501;
#[doc = " Out of buffer space."]
pub const nghttp2_error_NGHTTP2_ERR_BUFFER_ERROR: nghttp2_error = -502;
#[doc = " The specified protocol version is not supported."]
pub const nghttp2_error_NGHTTP2_ERR_UNSUPPORTED_VERSION: nghttp2_error = -503;
#[doc = " Used as a return value from :type:`nghttp2_send_callback2`,\n :type:`nghttp2_recv_callback` and\n :type:`nghttp2_send_data_callback` to indicate that the operation\n would block."]
pub const nghttp2_error_NGHTTP2_ERR_WOULDBLOCK: nghttp2_error = -504;
#[doc = " General protocol error"]
pub const nghttp2_error_NGHTTP2_ERR_PROTO: nghttp2_error = -505;
#[doc = " The frame is invalid."]
pub const nghttp2_error_NGHTTP2_ERR_INVALID_FRAME: nghttp2_error = -506;
#[doc = " The peer performed a shutdown on the connection."]
pub const nghttp2_error_NGHTTP2_ERR_EOF: nghttp2_error = -507;
...
pub const nghttp2_error_NGHTTP2_ERR_DEFERRED: nghttp2_error = -508;
#[doc = " Stream ID has reached the maximum value.  Therefore no stream ID\n is available."]
pub const nghttp2_error_NGHTTP2_ERR_STREAM_ID_NOT_AVAILABLE: nghttp2_error = -509;
#[doc = " The stream is already closed; or the stream ID is invalid."]
pub const nghttp2_error_NGHTTP2_ERR_STREAM_CLOSED: nghttp2_error = -510;
#[doc = " RST_STREAM has been added to the outbound queue.  The stream is\n in closing state."]
pub const nghttp2_error_NGHTTP2_ERR_STREAM_CLOSING: nghttp2_error = -511;
#[doc = " The transmission is not allowed for this stream (e.g., a frame\n with END_STREAM flag set has already sent)."]
pub const nghttp2_error_NGHTTP2_ERR_STREAM_SHUT_WR: nghttp2_error = -512;
#[doc = " The stream ID is invalid."]
pub const nghttp2_error_NGHTTP2_ERR_INVALID_STREAM_ID: nghttp2_error = -513;
#[doc = " The state of the stream is not valid (e.g., DATA cannot be sent\n to the stream if response HEADERS has not been sent)."]
pub const nghttp2_error_NGHTTP2_ERR_INVALID_STREAM_STATE: nghttp2_error = -514;
#[doc = " Another DATA frame has already been deferred."]
pub const nghttp2_error_NGHTTP2_ERR_DEFERRED_DATA_EXIST: nghttp2_error = -515;
#[doc = " Starting new stream is not allowed (e.g., GOAWAY has been sent\n and/or received)."]
pub const nghttp2_error_NGHTTP2_ERR_START_STREAM_NOT_ALLOWED: nghttp2_error = -516;
#[doc = " GOAWAY has already been sent."]
pub const nghttp2_error_NGHTTP2_ERR_GOAWAY_ALREADY_SENT: nghttp2_error = -517;
...
pub const nghttp2_error_NGHTTP2_ERR_INVALID_HEADER_BLOCK: nghttp2_error = -518;
#[doc = " Indicates that the context is not suitable to perform the\n requested operation."]
pub const nghttp2_error_NGHTTP2_ERR_INVALID_STATE: nghttp2_error = -519;
#[doc = " The user callback function failed due to the temporal error."]
pub const nghttp2_error_NGHTTP2_ERR_TEMPORAL_CALLBACK_FAILURE: nghttp2_error = -521;
#[doc = " The length of the frame is invalid, either too large or too small."]
pub const nghttp2_error_NGHTTP2_ERR_FRAME_SIZE_ERROR: nghttp2_error = -522;
#[doc = " Header block inflate/deflate error."]
pub const nghttp2_error_NGHTTP2_ERR_HEADER_COMP: nghttp2_error = -523;
#[doc = " Flow control error"]
pub const nghttp2_error_NGHTTP2_ERR_FLOW_CONTROL: nghttp2_error = -524;
#[doc = " Insufficient buffer size given to function."]
pub const nghttp2_error_NGHTTP2_ERR_INSUFF_BUFSIZE: nghttp2_error = -525;
#[doc = " Callback was paused by the application"]
pub const nghttp2_error_NGHTTP2_ERR_PAUSE: nghttp2_error = -526;
#[doc = " There are too many in-flight SETTING frame and no more\n transmission of SETTINGS is allowed."]
pub const nghttp2_error_NGHTTP2_ERR_TOO_MANY_INFLIGHT_SETTINGS: nghttp2_error = -527;
#[doc = " The server push is disabled."]
pub const nghttp2_error_NGHTTP2_ERR_PUSH_DISABLED: nghttp2_error = -528;
...
pub const nghttp2_error_NGHTTP2_ERR_DATA_EXIST: nghttp2_error = -529;
#[doc = " The current session is closing due to a connection error or\n `nghttp2_session_terminate_session()` is called."]
pub const nghttp2_error_NGHTTP2_ERR_SESSION_CLOSING: nghttp2_error = -530;
#[doc = " Invalid HTTP header field was received and stream is going to be\n closed."]
pub const nghttp2_error_NGHTTP2_ERR_HTTP_HEADER: nghttp2_error = -531;
#[doc = " Violation in HTTP messaging rule."]
pub const nghttp2_error_NGHTTP2_ERR_HTTP_MESSAGING: nghttp2_error = -532;
#[doc = " Stream was refused."]
pub const nghttp2_error_NGHTTP2_ERR_REFUSED_STREAM: nghttp2_error = -533;
#[doc = " Unexpected internal error, but recovered."]
pub const nghttp2_error_NGHTTP2_ERR_INTERNAL: nghttp2_error = -534;
#[doc = " Indicates that a processing was canceled."]
pub const nghttp2_error_NGHTTP2_ERR_CANCEL: nghttp2_error = -535;
#[doc = " When a local endpoint expects to receive SETTINGS frame, it\n receives an other type of frame."]
pub const nghttp2_error_NGHTTP2_ERR_SETTINGS_EXPECTED: nghttp2_error = -536;
#[doc = " When a local endpoint receives too many settings entries\n in a single SETTINGS frame."]
pub const nghttp2_error_NGHTTP2_ERR_TOO_MANY_SETTINGS: nghttp2_error = -537;
...
pub const nghttp2_error_NGHTTP2_ERR_FATAL: nghttp2_error = -900;
#[doc = " Out of memory.  This is a fatal error."]
pub const nghttp2_error_NGHTTP2_ERR_NOMEM: nghttp2_error = -901;
#[doc = " The user callback function failed.  This is a fatal error."]
pub const nghttp2_error_NGHTTP2_ERR_CALLBACK_FAILURE: nghttp2_error = -902;
#[doc = " Invalid client magic (see :macro:`NGHTTP2_CLIENT_MAGIC`) was\n received and further processing is not possible."]
pub const nghttp2_error_NGHTTP2_ERR_BAD_CLIENT_MAGIC: nghttp2_error = -903;
...
pub const nghttp2_error_NGHTTP2_ERR_FLOODED: nghttp2_error = -904;
#[doc = " When a local endpoint receives too many CONTINUATION frames\n following a HEADER frame."]
pub const nghttp2_error_NGHTTP2_ERR_TOO_MANY_CONTINUATIONS: nghttp2_error = -905;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_vec"][::std::mem::size_of::<nghttp2_vec>() - 16usize];
    ["Alignment of nghttp2_vec"][::std::mem::align_of::<nghttp2_vec>() - 8usize];
    ["Offset of field: nghttp2_vec::base"][::std::mem::offset_of!(nghttp2_vec, base) - 0usize];
    ["Offset of field: nghttp2_vec::len"][::std::mem::offset_of!(nghttp2_vec, len) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " No flag set."]
pub const nghttp2_nv_flag_NGHTTP2_NV_FLAG_NONE: nghttp2_nv_flag = 0;
#[doc = " Indicates that this name/value pair must not be indexed (\"Literal\n Header Field never Indexed\" representation must be used in HPACK\n encoding).  Other implementation calls this bit as \"sensitive\"."]
pub const nghttp2_nv_flag_NGHTTP2_NV_FLAG_NO_INDEX: nghttp2_nv_flag = 1;
#[doc = " This flag is set solely by application.  If this flag is set, the\n library does not make a copy of header field name.  This could\n improve performance."]
pub const nghttp2_nv_flag_NGHTTP2_NV_FLAG_NO_COPY_NAME: nghttp2_nv_flag = 2;
#[doc = " This flag is set solely by application.  If this flag is set, the\n library does not make a copy of header field value.  This could\n improve performance."]
pub const nghttp2_nv_flag_NGHTTP2_NV_FLAG_NO_COPY_VALUE: nghttp2_nv_flag = 4;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_nv"][::std::mem::size_of::<nghttp2_nv>() - 40usize];
    ["Alignment of nghttp2_nv"][::std::mem::align_of::<nghttp2_nv>() - 8usize];
    ["Offset of field: nghttp2_nv::name"][::std::mem::offset_of!(nghttp2_nv, name) - 0usize];
    ["Offset of field: nghttp2_nv::value"][::std::mem::offset_of!(nghttp2_nv, value) - 8usize];
    ["Offset of field: nghttp2_nv::namelen"][::std::mem::offset_of!(nghttp2_nv, namelen) - 16usize];
    ["Offset of field: nghttp2_nv::valuelen"]
        [::std::mem::offset_of!(nghttp2_nv, valuelen) - 24usize];
    ["Offset of field: nghttp2_nv::flags"][::std::mem::offset_of!(nghttp2_nv, flags) - 32usize];
};
#[doc = " The DATA frame."]
pub const nghttp2_frame_type_NGHTTP2_DATA: nghttp2_frame_type = 0;
#[doc = " The HEADERS frame."]
pub const nghttp2_frame_type_NGHTTP2_HEADERS: nghttp2_frame_type = 1;
#[doc = " The PRIORITY frame."]
pub const nghttp2_frame_type_NGHTTP2_PRIORITY: nghttp2_frame_type = 2;
#[doc = " The RST_STREAM frame."]
pub const nghttp2_frame_type_NGHTTP2_RST_STREAM: nghttp2_frame_type = 3;
#[doc = " The SETTINGS frame."]
pub const nghttp2_frame_type_NGHTTP2_SETTINGS: nghttp2_frame_type = 4;
#[doc = " The PUSH_PROMISE frame."]
pub const nghttp2_frame_type_NGHTTP2_PUSH_PROMISE: nghttp2_frame_type = 5;
#[doc = " The PING frame."]
pub const nghttp2_frame_type_NGHTTP2_PING: nghttp2_frame_type = 6;
#[doc = " The GOAWAY frame."]
pub const nghttp2_frame_type_NGHTTP2_GOAWAY: nghttp2_frame_type = 7;
#[doc = " The WINDOW_UPDATE frame."]
pub const nghttp2_frame_type_NGHTTP2_WINDOW_UPDATE: nghttp2_frame_type = 8;
#[doc = " The CONTINUATION frame.  This frame type won't be passed to any\n callbacks because the library processes this frame type and its\n preceding HEADERS/PUSH_PROMISE as a single frame."]
pub const nghttp2_frame_type_NGHTTP2_CONTINUATION: nghttp2_frame_type = 9;
#[doc = " The ALTSVC frame, which is defined in `RFC 7383\n <https://tools.ietf.org/html/rfc7838#section-4>`_."]
pub const nghttp2_frame_type_NGHTTP2_ALTSVC: nghttp2_frame_type = 10;
#[doc = " The ORIGIN frame, which is defined by `RFC 8336\n <https://tools.ietf.org/html/rfc8336>`_."]
pub const nghttp2_frame_type_NGHTTP2_ORIGIN: nghttp2_frame_type = 12;
#[doc = " The PRIORITY_UPDATE frame, which is defined by :rfc:`9218`."]
pub const nghttp2_frame_type_NGHTTP2_PRIORITY_UPDATE: nghttp2_frame_type = 16;
#[doc = " @enum\n\n The frame types in HTTP/2 specification."]
pub type nghttp2_frame_type = ::std::os::raw::c_uint;
#[doc = " No flag set."]
pub const nghttp2_flag_NGHTTP2_FLAG_NONE: nghttp2_flag = 0;
#[doc = " The END_STREAM flag."]
pub const nghttp2_flag_NGHTTP2_FLAG_END_STREAM: nghttp2_flag = 1;
#[doc = " The END_HEADERS flag."]
pub const nghttp2_flag_NGHTTP2_FLAG_END_HEADERS: nghttp2_flag = 4;
#[doc = " The ACK flag."]
pub const nghttp2_flag_NGHTTP2_FLAG_ACK: nghttp2_flag = 1;
#[doc = " The PADDED flag."]
pub const nghttp2_flag_NGHTTP2_FLAG_PADDED: nghttp2_flag = 8;
#[doc = " The PRIORITY flag."]
pub const nghttp2_flag_NGHTTP2_FLAG_PRIORITY: nghttp2_flag = 32;
...
pub const nghttp2_settings_id_NGHTTP2_SETTINGS_HEADER_TABLE_SIZE: nghttp2_settings_id = 1;
#[doc = " SETTINGS_ENABLE_PUSH"]
pub const nghttp2_settings_id_NGHTTP2_SETTINGS_ENABLE_PUSH: nghttp2_settings_id = 2;
#[doc = " SETTINGS_MAX_CONCURRENT_STREAMS"]
pub const nghttp2_settings_id_NGHTTP2_SETTINGS_MAX_CONCURRENT_STREAMS: nghttp2_settings_id = 3;
#[doc = " SETTINGS_INITIAL_WINDOW_SIZE"]
pub const nghttp2_settings_id_NGHTTP2_SETTINGS_INITIAL_WINDOW_SIZE: nghttp2_settings_id = 4;
#[doc = " SETTINGS_MAX_FRAME_SIZE"]
pub const nghttp2_settings_id_NGHTTP2_SETTINGS_MAX_FRAME_SIZE: nghttp2_settings_id = 5;
#[doc = " SETTINGS_MAX_HEADER_LIST_SIZE"]
pub const nghttp2_settings_id_NGHTTP2_SETTINGS_MAX_HEADER_LIST_SIZE: nghttp2_settings_id = 6;
#[doc = " SETTINGS_ENABLE_CONNECT_PROTOCOL\n (`RFC 8441 <https://tools.ietf.org/html/rfc8441>`_)"]
pub const nghttp2_settings_id_NGHTTP2_SETTINGS_ENABLE_CONNECT_PROTOCOL: nghttp2_settings_id = 8;
#[doc = " SETTINGS_NO_RFC7540_PRIORITIES (:rfc:`9218`)"]
pub const nghttp2_settings_id_NGHTTP2_SETTINGS_NO_RFC7540_PRIORITIES: nghttp2_settings_id = 9;
#[doc = " @enum\n The SETTINGS ID."]
pub type nghttp2_settings_id = ::std::os::raw::c_uint;
#[doc = " No errors."]
pub const nghttp2_error_code_NGHTTP2_NO_ERROR: nghttp2_error_code = 0;
#[doc = " PROTOCOL_ERROR"]
pub const nghttp2_error_code_NGHTTP2_PROTOCOL_ERROR: nghttp2_error_code = 1;
#[doc = " INTERNAL_ERROR"]
pub const nghttp2_error_code_NGHTTP2_INTERNAL_ERROR: nghttp2_error_code = 2;
#[doc = " FLOW_CONTROL_ERROR"]
pub const nghttp2_error_code_NGHTTP2_FLOW_CONTROL_ERROR: nghttp2_error_code = 3;
#[doc = " SETTINGS_TIMEOUT"]
pub const nghttp2_error_code_NGHTTP2_SETTINGS_TIMEOUT: nghttp2_error_code = 4;
#[doc = " STREAM_CLOSED"]
pub const nghttp2_error_code_NGHTTP2_STREAM_CLOSED: nghttp2_error_code = 5;
#[doc = " FRAME_SIZE_ERROR"]
pub const nghttp2_error_code_NGHTTP2_FRAME_SIZE_ERROR: nghttp2_error_code = 6;
#[doc = " REFUSED_STREAM"]
pub const nghttp2_error_code_NGHTTP2_REFUSED_STREAM: nghttp2_error_code = 7;
#[doc = " CANCEL"]
pub const nghttp2_error_code_NGHTTP2_CANCEL: nghttp2_error_code = 8;
#[doc = " COMPRESSION_ERROR"]
pub const nghttp2_error_code_NGHTTP2_COMPRESSION_ERROR: nghttp2_error_code = 9;
#[doc = " CONNECT_ERROR"]
pub const nghttp2_error_code_NGHTTP2_CONNECT_ERROR: nghttp2_error_code = 10;
#[doc = " ENHANCE_YOUR_CALM"]
pub const nghttp2_error_code_NGHTTP2_ENHANCE_YOUR_CALM: nghttp2_error_code = 11;
#[doc = " INADEQUATE_SECURITY"]
pub const nghttp2_error_code_NGHTTP2_INADEQUATE_SECURITY: nghttp2_error_code = 12;
#[doc = " HTTP_1_1_REQUIRED"]
pub const nghttp2_error_code_NGHTTP2_HTTP_1_1_REQUIRED: nghttp2_error_code = 13;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_frame_hd"][::std::mem::size_of::<nghttp2_frame_hd>() - 16usize];
    ["Alignment of nghttp2_frame_hd"][::std::mem::align_of::<nghttp2_frame_hd>() - 8usize];
    ["Offset of field: nghttp2_frame_hd::length"]
        [::std::mem::offset_of!(nghttp2_frame_hd, length) - 0usize];
    ["Offset of field: nghttp2_frame_hd::stream_id"]
        [::std::mem::offset_of!(nghttp2_frame_hd, stream_id) - 8usize];
    ["Offset of field: nghttp2_frame_hd::type_"]
        [::std::mem::offset_of!(nghttp2_frame_hd, type_) - 12usize];
    ["Offset of field: nghttp2_frame_hd::flags"]
        [::std::mem::offset_of!(nghttp2_frame_hd, flags) - 13usize];
    ["Offset of field: nghttp2_frame_hd::reserved"]
        [::std::mem::offset_of!(nghttp2_frame_hd, reserved) - 14usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_data_source"][::std::mem::size_of::<nghttp2_data_source>() - 8usize];
    ["Alignment of nghttp2_data_source"][::std::mem::align_of::<nghttp2_data_source>() - 8usize];
    ["Offset of field: nghttp2_data_source::fd"]
        [::std::mem::offset_of!(nghttp2_data_source, fd) - 0usize];
    ["Offset of field: nghttp2_data_source::ptr"]
        [::std::mem::offset_of!(nghttp2_data_source, ptr) - 0usize];
};
#[doc = " No flag set."]
pub const nghttp2_data_flag_NGHTTP2_DATA_FLAG_NONE: nghttp2_data_flag = 0;
#[doc = " Indicates EOF was sensed."]
pub const nghttp2_data_flag_NGHTTP2_DATA_FLAG_EOF: nghttp2_data_flag = 1;
...
pub const nghttp2_data_flag_NGHTTP2_DATA_FLAG_NO_END_STREAM: nghttp2_data_flag = 2;
#[doc = " Indicates that application will send complete DATA frame in\n :type:`nghttp2_send_data_callback`."]
pub const nghttp2_data_flag_NGHTTP2_DATA_FLAG_NO_COPY: nghttp2_data_flag = 4;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_data_provider"][::std::mem::size_of::<nghttp2_data_provider>() - 16usize];
    ["Alignment of nghttp2_data_provider"]
        [::std::mem::align_of::<nghttp2_data_provider>() - 8usize];
    ["Offset of field: nghttp2_data_provider::source"]
        [::std::mem::offset_of!(nghttp2_data_provider, source) - 0usize];
    ["Offset of field: nghttp2_data_provider::read_callback"]
        [::std::mem::offset_of!(nghttp2_data_provider, read_callback) - 8usize];
};
#[doc = " @struct\n\n This struct represents the data source and the way to read a chunk\n of data from it."]
#[repr(C)]
#[derive(Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_data_provider2"][::std::mem::size_of::<nghttp2_data_provider2>() - 16usize];
    ["Alignment of nghttp2_data_provider2"]
        [::std::mem::align_of::<nghttp2_data_provider2>() - 8usize];
    ["Offset of field: nghttp2_data_provider2::source"]
        [::std::mem::offset_of!(nghttp2_data_provider2, source) - 0usize];
    ["Offset of field: nghttp2_data_provider2::read_callback"]
        [::std::mem::offset_of!(nghttp2_data_provider2, read_callback) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_data"][::std::mem::size_of::<nghttp2_data>() - 24usize];
    ["Alignment of nghttp2_data"][::std::mem::align_of::<nghttp2_data>() - 8usize];
    ["Offset of field: nghttp2_data::hd"][::std::mem::offset_of!(nghttp2_data, hd) - 0usize];
    ["Offset of field: nghttp2_data::padlen"]
        [::std::mem::offset_of!(nghttp2_data, padlen) - 16usize];
};
#[doc = " The HEADERS frame is opening new stream, which is analogous to\n SYN_STREAM in SPDY."]
pub const nghttp2_headers_category_NGHTTP2_HCAT_REQUEST: nghttp2_headers_category = 0;
#[doc = " The HEADERS frame is the first response headers, which is\n analogous to SYN_REPLY in SPDY."]
pub const nghttp2_headers_category_NGHTTP2_HCAT_RESPONSE: nghttp2_headers_category = 1;
#[doc = " The HEADERS frame is the first headers sent against reserved\n stream."]
pub const nghttp2_headers_category_NGHTTP2_HCAT_PUSH_RESPONSE: nghttp2_headers_category = 2;
#[doc = " The HEADERS frame which does not apply for the above categories,\n which is analogous to HEADERS in SPDY.  If non-final response\n (e.g., status 1xx) is used, final response HEADERS frame will be\n categorized here."]
pub const nghttp2_headers_category_NGHTTP2_HCAT_HEADERS: nghttp2_headers_category = 3;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_priority_spec"][::std::mem::size_of::<nghttp2_priority_spec>() - 12usize];
    ["Alignment of nghttp2_priority_spec"]
        [::std::mem::align_of::<nghttp2_priority_spec>() - 4usize];
    ["Offset of field: nghttp2_priority_spec::stream_id"]
        [::std::mem::offset_of!(nghttp2_priority_spec, stream_id) - 0usize];
    ["Offset of field: nghttp2_priority_spec::weight"]
        [::std::mem::offset_of!(nghttp2_priority_spec, weight) - 4usize];
    ["Offset of field: nghttp2_priority_spec::exclusive"]
        [::std::mem::offset_of!(nghttp2_priority_spec, exclusive) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_headers"][::std::mem::size_of::<nghttp2_headers>() - 64usize];
    ["Alignment of nghttp2_headers"][::std::mem::align_of::<nghttp2_headers>() - 8usize];
    ["Offset of field: nghttp2_headers::hd"][::std::mem::offset_of!(nghttp2_headers, hd) - 0usize];
    ["Offset of field: nghttp2_headers::padlen"]
        [::std::mem::offset_of!(nghttp2_headers, padlen) - 16usize];
    ["Offset of field: nghttp2_headers::pri_spec"]
        [::std::mem::offset_of!(nghttp2_headers, pri_spec) - 24usize];
    ["Offset of field: nghttp2_headers::nva"]
        [::std::mem::offset_of!(nghttp2_headers, nva) - 40usize];
    ["Offset of field: nghttp2_headers::nvlen"]
        [::std::mem::offset_of!(nghttp2_headers, nvlen) - 48usize];
    ["Offset of field: nghttp2_headers::cat"]
        [::std::mem::offset_of!(nghttp2_headers, cat) - 56usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_priority"][::std::mem::size_of::<nghttp2_priority>() - 32usize];
    ["Alignment of nghttp2_priority"][::std::mem::align_of::<nghttp2_priority>() - 8usize];
    ["Offset of field: nghttp2_priority::hd"]
        [::std::mem::offset_of!(nghttp2_priority, hd) - 0usize];
    ["Offset of field: nghttp2_priority::pri_spec"]
        [::std::mem::offset_of!(nghttp2_priority, pri_spec) - 16usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_rst_stream"][::std::mem::size_of::<nghttp2_rst_stream>() - 24usize];
    ["Alignment of nghttp2_rst_stream"][::std::mem::align_of::<nghttp2_rst_stream>() - 8usize];
    ["Offset of field: nghttp2_rst_stream::hd"]
        [::std::mem::offset_of!(nghttp2_rst_stream, hd) - 0usize];
    ["Offset of field: nghttp2_rst_stream::error_code"]
        [::std::mem::offset_of!(nghttp2_rst_stream, error_code) - 16usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_settings_entry"][::std::mem::size_of::<nghttp2_settings_entry>() - 8usize];
    ["Alignment of nghttp2_settings_entry"]
        [::std::mem::align_of::<nghttp2_settings_entry>() - 4usize];
    ["Offset of field: nghttp2_settings_entry::settings_id"]
        [::std::mem::offset_of!(nghttp2_settings_entry, settings_id) - 0usize];
    ["Offset of field: nghttp2_settings_entry::value"]
        [::std::mem::offset_of!(nghttp2_settings_entry, value) - 4usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_settings"][::std::mem::size_of::<nghttp2_settings>() - 32usize];
    ["Alignment of nghttp2_settings"][::std::mem::align_of::<nghttp2_settings>() - 8usize];
    ["Offset of field: nghttp2_settings::hd"]
        [::std::mem::offset_of!(nghttp2_settings, hd) - 0usize];
    ["Offset of field: nghttp2_settings::niv"]
        [::std::mem::offset_of!(nghttp2_settings, niv) - 16usize];
    ["Offset of field: nghttp2_settings::iv"]
        [::std::mem::offset_of!(nghttp2_settings, iv) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_push_promise"][::std::mem::size_of::<nghttp2_push_promise>() - 48usize];
    ["Alignment of nghttp2_push_promise"][::std::mem::align_of::<nghttp2_push_promise>() - 8usize];
    ["Offset of field: nghttp2_push_promise::hd"]
        [::std::mem::offset_of!(nghttp2_push_promise, hd) - 0usize];
    ["Offset of field: nghttp2_push_promise::padlen"]
        [::std::mem::offset_of!(nghttp2_push_promise, padlen) - 16usize];
    ["Offset of field: nghttp2_push_promise::nva"]
        [::std::mem::offset_of!(nghttp2_push_promise, nva) - 24usize];
    ["Offset of field: nghttp2_push_promise::nvlen"]
        [::std::mem::offset_of!(nghttp2_push_promise, nvlen) - 32usize];
    ["Offset of field: nghttp2_push_promise::promised_stream_id"]
        [::std::mem::offset_of!(nghttp2_push_promise, promised_stream_id) - 40usize];
    ["Offset of field: nghttp2_push_promise::reserved"]
        [::std::mem::offset_of!(nghttp2_push_promise, reserved) - 44usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_ping"][::std::mem::size_of::<nghttp2_ping>() - 24usize];
    ["Alignment of nghttp2_ping"][::std::mem::align_of::<nghttp2_ping>() - 8usize];
    ["Offset of field: nghttp2_ping::hd"][::std::mem::offset_of!(nghttp2_ping, hd) - 0usize];
    ["Offset of field: nghttp2_ping::opaque_data"]
        [::std::mem::offset_of!(nghttp2_ping, opaque_data) - 16usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_goaway"][::std::mem::size_of::<nghttp2_goaway>() - 48usize];
    ["Alignment of nghttp2_goaway"][::std::mem::align_of::<nghttp2_goaway>() - 8usize];
    ["Offset of field: nghttp2_goaway::hd"][::std::mem::offset_of!(nghttp2_goaway, hd) - 0usize];
    ["Offset of field: nghttp2_goaway::last_stream_id"]
        [::std::mem::offset_of!(nghttp2_goaway, last_stream_id) - 16usize];
    ["Offset of field: nghttp2_goaway::error_code"]
        [::std::mem::offset_of!(nghttp2_goaway, error_code) - 20usize];
    ["Offset of field: nghttp2_goaway::opaque_data"]
        [::std::mem::offset_of!(nghttp2_goaway, opaque_data) - 24usize];
    ["Offset of field: nghttp2_goaway::opaque_data_len"]
        [::std::mem::offset_of!(nghttp2_goaway, opaque_data_len) - 32usize];
    ["Offset of field: nghttp2_goaway::reserved"]
        [::std::mem::offset_of!(nghttp2_goaway, reserved) - 40usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_window_update"][::std::mem::size_of::<nghttp2_window_update>() - 24usize];
    ["Alignment of nghttp2_window_update"]
        [::std::mem::align_of::<nghttp2_window_update>() - 8usize];
    ["Offset of field: nghttp2_window_update::hd"]
        [::std::mem::offset_of!(nghttp2_window_update, hd) - 0usize];
    ["Offset of field: nghttp2_window_update::window_size_increment"]
        [::std::mem::offset_of!(nghttp2_window_update, window_size_increment) - 16usize];
    ["Offset of field: nghttp2_window_update::reserved"]
        [::std::mem::offset_of!(nghttp2_window_update, reserved) - 20usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_extension"][::std::mem::size_of::<nghttp2_extension>() - 24usize];
    ["Alignment of nghttp2_extension"][::std::mem::align_of::<nghttp2_extension>() - 8usize];
    ["Offset of field: nghttp2_extension::hd"]
        [::std::mem::offset_of!(nghttp2_extension, hd) - 0usize];
    ["Offset of field: nghttp2_extension::payload"]
        [::std::mem::offset_of!(nghttp2_extension, payload) - 16usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_frame"][::std::mem::size_of::<nghttp2_frame>() - 64usize];
    ["Alignment of nghttp2_frame"][::std::mem::align_of::<nghttp2_frame>() - 8usize];
    ["Offset of field: nghttp2_frame::hd"][::std::mem::offset_of!(nghttp2_frame, hd) - 0usize];
    ["Offset of field: nghttp2_frame::data"][::std::mem::offset_of!(nghttp2_frame, data) - 0usize];
    ["Offset of field: nghttp2_frame::headers"]
        [::std::mem::offset_of!(nghttp2_frame, headers) - 0usize];
    ["Offset of field: nghttp2_frame::priority"]
        [::std::mem::offset_of!(nghttp2_frame, priority) - 0usize];
    ["Offset of field: nghttp2_frame::rst_stream"]
        [::std::mem::offset_of!(nghttp2_frame, rst_stream) - 0usize];
    ["Offset of field: nghttp2_frame::settings"]
        [::std::mem::offset_of!(nghttp2_frame, settings) - 0usize];
    ["Offset of field: nghttp2_frame::push_promise"]
        [::std::mem::offset_of!(nghttp2_frame, push_promise) - 0usize];
    ["Offset of field: nghttp2_frame::ping"][::std::mem::offset_of!(nghttp2_frame, ping) - 0usize];
    ["Offset of field: nghttp2_frame::goaway"]
        [::std::mem::offset_of!(nghttp2_frame, goaway) - 0usize];
    ["Offset of field: nghttp2_frame::window_update"]
        [::std::mem::offset_of!(nghttp2_frame, window_update) - 0usize];
    ["Offset of field: nghttp2_frame::ext"][::std::mem::offset_of!(nghttp2_frame, ext) - 0usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_mem"][::std::mem::size_of::<nghttp2_mem>() - 40usize];
    ["Alignment of nghttp2_mem"][::std::mem::align_of::<nghttp2_mem>() - 8usize];
    ["Offset of field: nghttp2_mem::mem_user_data"]
        [::std::mem::offset_of!(nghttp2_mem, mem_user_data) - 0usize];
    ["Offset of field: nghttp2_mem::malloc"][::std::mem::offset_of!(nghttp2_mem, malloc) - 8usize];
    ["Offset of field: nghttp2_mem::free"][::std::mem::offset_of!(nghttp2_mem, free) - 16usize];
    ["Offset of field: nghttp2_mem::calloc"][::std::mem::offset_of!(nghttp2_mem, calloc) - 24usize];
    ["Offset of field: nghttp2_mem::realloc"]
        [::std::mem::offset_of!(nghttp2_mem, realloc) - 32usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_extpri"][::std::mem::size_of::<nghttp2_extpri>() - 8usize];
    ["Alignment of nghttp2_extpri"][::std::mem::align_of::<nghttp2_extpri>() - 4usize];
    ["Offset of field: nghttp2_extpri::urgency"]
        [::std::mem::offset_of!(nghttp2_extpri, urgency) - 0usize];
    ["Offset of field: nghttp2_extpri::inc"][::std::mem::offset_of!(nghttp2_extpri, inc) - 4usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_ext_altsvc"][::std::mem::size_of::<nghttp2_ext_altsvc>() - 32usize];
    ["Alignment of nghttp2_ext_altsvc"][::std::mem::align_of::<nghttp2_ext_altsvc>() - 8usize];
    ["Offset of field: nghttp2_ext_altsvc::origin"]
        [::std::mem::offset_of!(nghttp2_ext_altsvc, origin) - 0usize];
    ["Offset of field: nghttp2_ext_altsvc::origin_len"]
        [::std::mem::offset_of!(nghttp2_ext_altsvc, origin_len) - 8usize];
    ["Offset of field: nghttp2_ext_altsvc::field_value"]
        [::std::mem::offset_of!(nghttp2_ext_altsvc, field_value) - 16usize];
    ["Offset of field: nghttp2_ext_altsvc::field_value_len"]
        [::std::mem::offset_of!(nghttp2_ext_altsvc, field_value_len) - 24usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_origin_entry"][::std::mem::size_of::<nghttp2_origin_entry>() - 16usize];
    ["Alignment of nghttp2_origin_entry"][::std::mem::align_of::<nghttp2_origin_entry>() - 8usize];
    ["Offset of field: nghttp2_origin_entry::origin"]
        [::std::mem::offset_of!(nghttp2_origin_entry, origin) - 0usize];
    ["Offset of field: nghttp2_origin_entry::origin_len"]
        [::std::mem::offset_of!(nghttp2_origin_entry, origin_len) - 8usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_ext_origin"][::std::mem::size_of::<nghttp2_ext_origin>() - 16usize];
    ["Alignment of nghttp2_ext_origin"][::std::mem::align_of::<nghttp2_ext_origin>() - 8usize];
    ["Offset of field: nghttp2_ext_origin::nov"]
        [::std::mem::offset_of!(nghttp2_ext_origin, nov) - 0usize];
    ["Offset of field: nghttp2_ext_origin::ov"]
        [::std::mem::offset_of!(nghttp2_ext_origin, ov) - 8usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp2_ext_priority_update"]
        [::std::mem::size_of::<nghttp2_ext_priority_update>() - 24usize];
    ["Alignment of nghttp2_ext_priority_update"]
        [::std::mem::align_of::<nghttp2_ext_priority_update>() - 8usize];
    ["Offset of field: nghttp2_ext_priority_update::stream_id"]
        [::std::mem::offset_of!(nghttp2_ext_priority_update, stream_id) - 0usize];
    ["Offset of field: nghttp2_ext_priority_update::field_value"]
        [::std::mem::offset_of!(nghttp2_ext_priority_update, field_value) - 8usize];
    ["Offset of field: nghttp2_ext_priority_update::field_value_len"]
        [::std::mem::offset_of!(nghttp2_ext_priority_update, field_value_len) - 16usize];
};
unsafe extern "C" {
...
#[doc = " No flag set."]
pub const nghttp2_hd_inflate_flag_NGHTTP2_HD_INFLATE_NONE: nghttp2_hd_inflate_flag = 0;
#[doc = " Indicates all headers were inflated."]
pub const nghttp2_hd_inflate_flag_NGHTTP2_HD_INFLATE_FINAL: nghttp2_hd_inflate_flag = 1;
#[doc = " Indicates a header was emitted."]
pub const nghttp2_hd_inflate_flag_NGHTTP2_HD_INFLATE_EMIT: nghttp2_hd_inflate_flag = 2;
...
#[doc = " idle state."]
pub const nghttp2_stream_proto_state_NGHTTP2_STREAM_STATE_IDLE: nghttp2_stream_proto_state = 1;
#[doc = " open state."]
pub const nghttp2_stream_proto_state_NGHTTP2_STREAM_STATE_OPEN: nghttp2_stream_proto_state = 2;
#[doc = " reserved (local) state."]
pub const nghttp2_stream_proto_state_NGHTTP2_STREAM_STATE_RESERVED_LOCAL:
    nghttp2_stream_proto_state = 3;
#[doc = " reserved (remote) state."]
pub const nghttp2_stream_proto_state_NGHTTP2_STREAM_STATE_RESERVED_REMOTE:
    nghttp2_stream_proto_state = 4;
#[doc = " half closed (local) state."]
pub const nghttp2_stream_proto_state_NGHTTP2_STREAM_STATE_HALF_CLOSED_LOCAL:
    nghttp2_stream_proto_state = 5;
#[doc = " half closed (remote) state."]
pub const nghttp2_stream_proto_state_NGHTTP2_STREAM_STATE_HALF_CLOSED_REMOTE:
    nghttp2_stream_proto_state = 6;
#[doc = " closed state."]
pub const nghttp2_stream_proto_state_NGHTTP2_STREAM_STATE_CLOSED: nghttp2_stream_proto_state = 7;
...
pub type nghttp2_debug_vprintf_callback = ::std::option::Option<
...
unsafe extern "C" {
    ...
    pub fn nghttp2_set_debug_vprintf_callback(
        debug_vprintf_callback: nghttp2_debug_vprintf_callback,
    );
}
